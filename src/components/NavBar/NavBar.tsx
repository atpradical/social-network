...
export const NavBar = () => {
    return (
        <nav className={s.nav}>
            ...
            <div className={s.item}><NavLink to={'/dialogs'} activeClassName={s.activeLink}>Dialogs</NavLink>
            </div><div className={s.item}><NavLink to={'/users'} activeClassName={s.activeLink}>Users</NavLink></div>
